                ...
                {output ? (
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                    ...
                    <div className="flex gap-2 items-start">
                      <button
                        onClick={() => playAudio(output, toLang)}
                        className="px-3 py-1 rounded-lg bg-gray-50 border border-gray-200 text-sm hover:bg-gray-100"
                      >
                        {t("translator.play")}
                      </button>
                ...
                {favorites.length ? favorites.map((f) => (
                  <div key={f.id} className="flex items-start justify-between bg-gray-50 p-3 rounded-lg border border-gray-100">
                    ...
                    <div className="flex flex-col gap-2">
                      <button onClick={() => playAudio(f.output, f.to)} className="px-2 py-1 text-xs border rounded-lg">Play</button>
