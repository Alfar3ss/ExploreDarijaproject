...
export default function ContactPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 md:px-8 py-12">
      ...
      <p className="text-gray-700 mb-4">Have questions or feedback? Drop us a message at <a href="mailto:hello@exploredarija.example" className="text-primary">hello@exploredarija.example</a>.</p>
      <div className="mt-6">
